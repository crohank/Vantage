...
def run_research_analysis(
    ...
    # Gather telemetry summary
    try:
        from services.telemetry import get_telemetry_db
        telemetry_summary = get_telemetry_db().get_analysis_summary(analysis_id)
        result["_telemetry"] = telemetry_summary
    except Exception as e:
        print(f"[Telemetry] Warning: could not gather summary: {e}")
        result["_telemetry"] = {}
